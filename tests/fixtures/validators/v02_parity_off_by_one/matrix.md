...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| R-1 | Validate inputs | RFC 1.0:L3 | Intake Classifier | hard gate | intake boundary | prompt file | UserRequest.context | intake.classify | Test-1 | covered | - |
...
| R-3 | Extra mapping row | RFC 1.0:L3 | Intake Classifier | hard gate | intake boundary | prompt file | UserRequest.task | intake.classify | Test-3 | covered | - |
