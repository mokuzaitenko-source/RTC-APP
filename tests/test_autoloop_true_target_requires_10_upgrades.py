...
class AutoloopTrueTargetTests(TestCase):
    def setUp(self) -> None:
        self.mod = _load_module()

    def test_strict_does_not_target_reach_without_upgrade_target(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertNotEqual(summary["stop_reason"], "target_reached")
